...
function initMenuSlider() {
  ...
  const prevButton = document.getElementById("menuPrev");
  const nextButton = document.getElementById("menuNext");
  ...
  function getScrollAmount() {
    const firstCard = slider.querySelector(".menu-poster");
  ...
  function updateButtons() {
    ...
    nextButton.disabled = slider.scrollLeft >= maxScroll - 5;
  }
...
function initLightbox() {
  ...
  function openLightbox(button) {
    ...
    image.alt = button.dataset.title || "Menu Kopi C Shake";
    title.textContent = button.dataset.title || "Menu Kopi C Shake";
